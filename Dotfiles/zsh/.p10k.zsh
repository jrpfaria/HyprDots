...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%1F'  # grey foreground
      local      clean='%1F'  # grey foreground
      local   modified='%1F'  # grey foreground
      local  untracked='%1F'  # grey foreground
      local conflicted='%1F'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_ASDF_FOREGROUND=1
  ...
  typeset -g POWERLEVEL9K_NORDVPN_FOREGROUND=1
  ...
  ######################[ nnn: nnn shell (https://github.com/jarun/nnn) ]#######################
  # Nnn shell color.
  typeset -g POWERLEVEL9K_NNN_FOREGROUND=1
  # Custom icon.
  # typeset -g POWERLEVEL9K_NNN_VISUAL_IDENTIFIER_EXPANSION='⭐'

  ######################[ lf: lf shell (https://github.com/gokcehan/lf) ]#######################
  # lf shell color.
  typeset -g POWERLEVEL9K_LF_FOREGROUND=1
  # Custom icon.
